...
public class HeadlessRunner : IDisposable
{
    ...
    public async Task InitializeEngineAsync()
    {
        ...
        await this._engine.Initialize(path, options, this._systemInfo, null, new LoggerEngineInitProgress(this._logger));
        ...
        this._logger.LogInfo(ResoCategory.Runner, $"Userspace initialized after {sw.ElapsedMilliseconds}ms, starting engine loop.");
